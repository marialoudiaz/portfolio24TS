  ...
  const indepArray = [
    {
      ...
      accordion: [
        ...
        'Imaginez que vous lanciez votre entreprise. Le designer de marque, c’est celui qui traduit votre histoire en images. Il crée votre logo, choisit les couleurs et les typographies qui reflètent votre personnalité. Grâce à lui, votre marque devient reconnaissable et mémorable dès le premier regard, parlant de vous sans un mot. Plus simplement ? Je crée l’identité visuelle et émotionnelle de votre marque. Le logo, les couleurs, la typographie jusqu’aux supports visuelles imprimés et web. Pour que votre marque soit instantanément reconnaissable et connecte avec votre audience.',
